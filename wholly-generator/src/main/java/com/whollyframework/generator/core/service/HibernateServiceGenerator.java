...
public class HibernateServiceGenerator extends AbstractGenerator {

	public final static String IMPL = "Impl";
	
	public HibernateServiceGenerator() {
		super("Hibernate.Service");
	}
	...
	protected void initJavaModel(JavaModel model, Map<String, String> prop) {
		...
		model.setBaseServiceName("HibernateCurdService");
	}
