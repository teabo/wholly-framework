package com.whollyframework.spring.mvc.view;
 ...
 *
 */
public class CEMultipleViewResolver implements ViewResolver, Ordered {

	/**
	 * The default logger.
	 */
	private static final Logger logger = Logger
			.getLogger(CEMultipleViewResolver.class);
					...
					if (viewName.endsWith(suffix)) {
						...
						if (null != viewResolver) {
							if (logger.isDebugEnabled()) {
								logger.debug("found viewResolver '"
										+ viewResolver + "' for viewName '"
										+ viewName + "'");
							}
	 ...
	 * {@link org.springframework.web.servlet.ViewResolver} is evaluated.
	 */
