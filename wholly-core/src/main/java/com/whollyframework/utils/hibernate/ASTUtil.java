// $Id: ASTUtil.java,v 1.1 2011/10/21 08:56:28 chris Exp $
package com.whollyframework.utils.hibernate;
...
public final class ASTUtil {
	...
	public static List<AST> collectChildren(AST root, FilterPredicate predicate) {
	...
	private static class CollectingNodeVisitor implements NodeTraverser.VisitationStrategy {
		...
		private final List<AST> collectedNodes = new ArrayList<AST>();
	...
	@SuppressWarnings("unused")
	private static void collectChildren(List<AST> children, AST root, FilterPredicate predicate) {
