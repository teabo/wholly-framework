...
public class UrlUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		// 将Map中的参数添加到URL
		String newURL = UrlUtil.parameterize("/obpm/portal?bbb=bbbvalue", parameters);
		...
		URL url = new URL("http://localhost:8080/obpm-cas/login");
		System.out.println("path: " + url.toExternalForm());
		System.out.println(url.getPath().split("/").length);
		System.out.println(getServerName("http://localhost:8080/obpm-cas/login"));
		System.out.println(getUrlPrefix("http://localhost:8080/obpm-cas/login"));
	}
}
