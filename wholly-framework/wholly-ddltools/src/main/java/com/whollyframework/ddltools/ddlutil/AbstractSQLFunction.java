...
public class AbstractSQLFunction {
	...
	public final static String PRE_LIMIT_SQL = "SELECT * FROM ( SELECT ROW_.*, ROWNUM ROWNUM_ FROM ( ";
	
	public final static String MID_LIMIT_SQL = " ) ROW_ WHERE ROWNUM <= ";
	
	public final static String END_LIMIT_SQL = ") WHERE ROWNUM_ > ";
	...
	public String getLimitString(String sql, int startline, int endline) {
		...
		pagingSelect.append(PRE_LIMIT_SQL);
		pagingSelect.append(sql);
		pagingSelect.append(MID_LIMIT_SQL);
		pagingSelect.append(endline);
		pagingSelect.append(END_LIMIT_SQL);
		pagingSelect.append(startline);
