 ...
 */
package com.whollyframework.util.reflect;
...
public class ReflectUtil {
	...
	public static Field getAccessibleField(final Object obj, final String fieldName) {
		if (obj == null){
			throw convertReflectionExceptionToUnchecked(new Exception("object不能为空"));
		}
		if (StringUtil.isBlank(fieldName)){
			throw convertReflectionExceptionToUnchecked(new Exception("fieldName不能为空"));
		}
