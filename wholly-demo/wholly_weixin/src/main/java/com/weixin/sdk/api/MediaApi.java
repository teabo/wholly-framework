...
public class MediaApi {
	...
	public static ApiResult addNews(List<MediaArticles> mediaArticles) {
		...
		String jsonResult = HttpKit.post(url, JsonUtil.toJson(dataMap));
	...
	public static ApiResult addMaterial(File file, String title, String introduction) {
		...
		try {
			return uploadMedia(url, file, JsonUtil.toJson(dataMap));
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static InputStream getMaterial(String media_id) {
		...
		try {
			return downloadMaterial(url, JsonUtil.toJson(dataMap));
		} catch (IOException e) {
			throw new RuntimeException(e);
		}
	}
