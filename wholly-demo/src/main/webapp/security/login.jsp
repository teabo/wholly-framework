...
<head>
<title><%=SysEnvironment.getInstance().getWebSiteTitle() %>-登录</title>
...
// 			startLoading("登录");
	...
	<body class="login_bg"  style="overflow-x: hidden;overflow-y: hidden;overflow: hidden;">
	 <!--头部部分-->
					...
					<form id="login-form" method="post" style="position:relative;">
						...
						<table style="width:100%;margin-top:20px;border-collapse:collapse;font-size:12px;">
							...
							<tr class="tr3">
								<td>&nbsp;</td>
								<td class="td_right">
									<input type="text" class="validate_num" value="输入验证码" name="authImg" data-options="required:true,validType:'length[1,6]'" />
		...
		<!--底部版权-->
		<div class="login_footer">广州阳光耐特电子有限公司&nbsp;&nbsp;技术支持 客户端要求：IE6.0或以上，1024*768像素或以上</div>
	</body>
</html>
