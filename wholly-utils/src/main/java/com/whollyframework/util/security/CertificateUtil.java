...
public class CertificateUtil {
	 ...
	 * @throws Exception
	 */
	public static PrivateKey getPrivateKey(String certificateFile, final String password) {
		PrivateKey privateKey = null;

		try {
			String certFile = certificateFile.toLowerCase();
			byte[] key = fileToByte(certificateFile);
			...
			throw new RuntimeException("【异常】：读取证书密钥失败："+e.getMessage());
		}
		return privateKey;
	}
	...
	public static String encryptFileToBase64ByPrivateKey(String filePath, String keyStorePath, String alias,
		...
		return Base64.encode2String(encryptedData);
	}
	...
	public static String signToBase64(byte[] data, String keyStorePath, String alias, String password)
			throws Exception {
		return Base64.encode2String(sign(data, keyStorePath, alias, password));
	}
	...
	public static String signFileToBase64(String filePath, String keyStorePath, String alias, String password)
			throws Exception {
		return Base64.encode2String(generateFileSign(filePath, keyStorePath, alias, password));
	}
	...
	public static boolean verifyBase64SignWithDecrypt(String base64String, String sign, String certificatePath)
			throws Exception {
		byte[] encryptedData = Base64.decode(base64String);
	 ...
	 * @return
	 */
	private static boolean verifyCertificate(Date date, String certificatePath) {
	 ...
	 * @return
	 */
	private static boolean verifyCertificate(Date date, String keyStorePath, String alias, String password) {
		Certificate certificate;
		try {
	...
	private static void closeQuitely(Closeable close) {
		if (close != null)
			try {
				close.close();
			} catch (IOException e) {
	...
	public static void main(String[] args) throws Exception {
		String keyStorePath = "D:\\software\\CA证书制作工具\\teabo.cn.cer";
		X509Certificate t = (X509Certificate) CertificateUtil.getCertificate(keyStorePath);
